namespace Fleux.Core.NativeHelpers
{
    ...
    public interface IImagingFactory
    {
        ...
        uint CreateImageFromBuffer([MarshalAs(UnmanagedType.LPArray)] byte[] buffer,
                                   uint size,
        ...
        uint CreateBitmapFromImage(IImage image,
                                   uint width,
                                   uint height,
    ...
    public interface IImage
    {
        ...
        // uint Draw(IntPtr hdc, ref Rectangle dstRect, ref Rectangle srcRect); // "Correct" declaration: uint Draw(IntPtr hdc, ref Rectangle dstRect, ref Rectangle srcRect);
        [SuppressMessage("Microsoft.StyleCop.CSharp.NamingRules", "SA1306:FieldNamesMustBeginWithLowerCaseLetter",
